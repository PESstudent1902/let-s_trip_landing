  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="bg-abyss/90 backdrop-blur-xl border-t border-white/5 px-4 py-3">
            <a
              href="https://wa.me/918867767171"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full py-3.5 bg-green-600 text-white font-bold rounded-xl active:scale-[0.98] transition-transform text-sm"
