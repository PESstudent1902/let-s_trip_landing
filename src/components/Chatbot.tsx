...
export default function Chatbot() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.error) {
        setMessages((prev) => [...prev, { role: "assistant", content: `Sorry, something went wrong. Please try again or fill out our online inquiry form.` }]);
      ...
      setMessages((prev) => [...prev, { role: "assistant", content: "Connection issue. Please try again or fill out our online inquiry form." }]);
    } finally {
      setIsLoading(false);
    }
  };
