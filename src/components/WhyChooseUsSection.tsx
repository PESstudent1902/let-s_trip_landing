...
const features = [
  ...
  { icon: Palmtree, title: "Top Notch Support", description: "24/7 dedicated support — always ready to assist you", accent: "from-violet/20 to-cyan/10", iconColor: "text-violet" },
];
